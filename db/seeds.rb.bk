...
min_i00 = "in"
mout_i00 = "out"
met_i00 = Item.create!(item_type: 'metric', description: 'nº', updated_by: 'seed')
met_i39 = Item.create!(item_type: 'metric', description: 'nº de contratos menores tramitados', updated_by: 'seed')
met_i99 = met_i50 = met_i30 = met_i128 = met_i137 = met_i41 = Item.create!(item_type: 'metric', description: 'nº de expedientes', updated_by: 'seed')
met_i43 = Item.create!(item_type: 'metric', description: 'nº de contratos menores iniciados', updated_by: 'seed')
met_i63 = Item.create!(item_type: 'metric', description: 'nº de contratos', updated_by: 'seed')
met_i44 = Item.create!(item_type: 'metric', description: 'nº de convenios tramitados', updated_by: 'seed')
met_i67 = met_i138 = Item.create!(item_type: 'metric', description: 'nº de facturas', updated_by: 'seed')
met_i40 = Item.create!(item_type: 'metric', description: 'nº de propuestas', updated_by: 'seed')
met_i38 = Item.create!(item_type: 'metric', description: 'nº de consultas', updated_by: 'seed')
met_i52 = Item.create!(item_type: 'metric', description: 'nº de documentos contables', updated_by: 'seed')
...
j = 0
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp1_1.id, order: (j=j+1))
    ...
    i = 0
    ind = Indicator.create!(task_id: tk.id, item_id: it_i39.id, in_out: min_i00, metric: met_i39.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, item_id: it_i41.id, in_out: min_i00, metric: met_i41.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, item_id: it_i63.id, in_out: min_i00, metric: met_i63.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, item_id: it_i44.id, in_out: min_i00, metric: met_i44.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, item_id: it_i30.id, in_out: min_i00, metric: met_i30.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut2.id, item_id: it_sp1_2.id, order: (j=j+1))
    i = 0
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i43.id, metric: met_i43.id, order: (i=i+1), total_process: 0, total_sub_process: 1)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i41.id, metric: met_i41.id, order: (i=i+1), total_process: 0, total_sub_process: 1)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i63.id, metric: met_i63.id, order: (i=i+1), total_process: 0, total_sub_process: 1)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i30.id, metric: met_i30.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i67.id, metric: met_i67.id, order: (i=i+1), total_process: 0, total_sub_process: 1)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut3.id, item_id: it_sp1_3.id, order: (j=j+1))
    i = 0
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i40.id, metric: met_i40.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i138.id, metric: met_i138.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i52.id, metric: met_i52.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i137.id, metric: met_i137.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i128.id, metric: met_i128.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i99.id, metric: met_i99.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i50.id, metric: met_i50.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i30.id, metric: met_i30.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut4.id, item_id: it_sp1_4.id, order: (j=j+1))
    i = 0
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i39.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i62.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i30.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
    ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i67.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut6.id, item_id: it_sp1_6.id, order: (j=j+1))
    i = 0
   tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
   ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i43.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
   ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i62.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
   ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i30.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
   ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i44.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
   ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i67.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
j = 0
      sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp2_1.id, order: (j=j+1))
        tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
        i = 0
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i151.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i149.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i148.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i114.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i135.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i108.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i60.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i139.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i109.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i33.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ...
      sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut4.id, item_id: it_sp2_4.id, order: (j=j+1))
        ...
        tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i33.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i21.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)

      sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut5.id, item_id: it_sp2_5.id, order: (j=j+1))
        tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
        i = 0
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i29.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)

      sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut6.id, item_id: it_sp2_6.id, order: (j=j+1))
        tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
        i = 0
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i32.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
        ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i22.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp3
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp3_1.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i = 0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i98.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i31.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i45.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i96.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i97.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i95.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i38.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i37.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i116.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i61.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut7.id, item_id: it_sp3_7.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i = 0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i115.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp4
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut2.id, item_id: it_sp4_2.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i = 0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i87.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i89.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i90.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut7.id, item_id: it_sp4_7.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i = 0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i84.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i88.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp5
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp5_1.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i = 0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i65.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i64.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut7.id, item_id: it_sp5_7.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i121.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i145.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp6
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp6_1.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i82.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut2.id, item_id: it_sp6_2.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i47.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut7.id, item_id: it_sp6_7.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i48.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i49.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i110.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp7
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp7_1.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i132.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i133.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i81.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i131.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut4.id, item_id: it_sp7_4.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i46.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp8
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp8_1.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i80.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp9
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut2.id, item_id: it_sp9_2.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i105.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i106.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i107.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i100.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i117.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i136.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i92.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp10
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut2.id, item_id: it_sp10_2.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i23.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp11
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut4.id, item_id: it_sp11_4.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i3.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i9.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i12.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i13.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut6.id, item_id: it_sp11_6.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i10.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i27.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i26.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i147.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i113.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp12
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut5.id, item_id: it_sp12_5.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i8.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i11.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
j = 0
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut3.id, item_id: it_sp13_3.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i52.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut4.id, item_id: it_sp13_4.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i142.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i141.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i134.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut5.id, item_id: it_sp13_5.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i118.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut6.id, item_id: it_sp13_6.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i24.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i17.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i101.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i102.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i103.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp14
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp14_1.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i2.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i57.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
j = 0
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp15_1.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i34.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i25.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i54.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut3.id, item_id: it_sp15_3.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i91.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i51.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp16
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp16_1.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i120.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i104.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut3.id, item_id: it_sp16_3.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i56.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i152.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i70.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp17
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut3.id, item_id: it_sp17_3.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i68.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp18
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp18_1.id, order: (j=j+1))
    ...
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i77.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut2.id, item_id: it_sp18_2.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i79.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut4.id, item_id: it_sp18_4.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i153.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut5.id, item_id: it_sp18_5.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i19.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut6.id, item_id: it_sp18_6.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i14.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i119.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i154.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut7.id, item_id: it_sp18_7.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i18.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
j = 0
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut2.id, item_id: it_sp19_2.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i78.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut3.id, item_id: it_sp19_3.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i73.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut4.id, item_id: it_sp19_4.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i71.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut5.id, item_id: it_sp19_5.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i74.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut6.id, item_id: it_sp19_6.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i76.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut7.id, item_id: it_sp19_7.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i75.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut8.id, item_id: it_sp19_8.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i72.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp20
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp20_1.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i129.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i58.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
j = 0
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut1.id, item_id: it_sp21_4.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i35.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut2.id, item_id: it_sp21_6.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i112.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut3.id, item_id: it_sp21_8.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i93.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i35.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i36.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp22
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut8.id, item_id: it_sp22_8.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i53.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i28.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i94.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp23
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut8.id, item_id: it_sp23_8.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i124.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i122.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i123.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i125.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i126.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i16.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
mp = mp24
  ...
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut8.id, item_id: it_sp24_8.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i69.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i127.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i140.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
...
j = 0
  sp = SubProcess.create!(main_process_id: mp.id, unit_type_id: ut8.id, item_id: it_sp25_8.id, order: (j=j+1))
    tk = Task.create!(sub_process_id: sp.id, item_id: it_tarea.id, order: 1)
      i=0
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i15.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i146.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i83.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
      ind = Indicator.create!(task_id: tk.id, in_out: min_i00, item_id: it_i130.id, metric: met_i00.id, order: (i=i+1), total_process: 0, total_sub_process: 0)
