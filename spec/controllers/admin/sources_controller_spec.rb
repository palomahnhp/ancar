...
RSpec.describe Admin::SourcesController, type: :controller do
  ...
  # Admin::Source. As you add validations to Admin::Source, be sure to
  ...
  describe "GET #index" do
    it "assigns all admin_sources as @admin_sources" do
      source = Admin::Source.create! valid_attributes
      get :index, params: {}, session: valid_session
      expect(assigns(:admin_sources)).to eq([source])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new admin_source as @admin_source" do
      ...
      expect(assigns(:admin_source)).to be_a_new(Admin::Source)
    end
  end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the admin_sources list" do
      source = Admin::Source.create! valid_attributes
      delete :destroy, params: {id: source.to_param}, session: valid_session
      expect(response).to redirect_to(admin_sources_url)
    end
  end
